		...
		>
					...
					<FormControl isInvalid={timeLimitError} isRequired>
						...
						<Center>
							<Slider
								...
								focusThumbOnChange={false}
								value={
									((timeLimit - 5) / 5) * (100 / (175 / 5))
								}
								onChange={(value) =>
									setTimeLimit(
										Math.floor(value / (100 / (175 / 5))) *
											5 +
											5
									)
								}
			...
			<GridItem>
				<Center>
					<FormControl>
						...
						/>
						<FormHelperText mt={1}>
							Private matches don't show up on the table
							(invite-only).
						</FormHelperText>
					</FormControl>
				</Center>
			...
			<GridItem colSpan={2}>
				<FormControl>
					...
					<FormHelperText mt={1}>
						This uses your username (must be valid) on the selected
						platform. Otherwise, you can use any username you'd
						like.
					</FormHelperText>
				</FormControl>
			</GridItem>
