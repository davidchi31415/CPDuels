        ...
        <Tr>
          <Td height='15em' borderColor='grey.100'>
            <Grid templateColumns='repeat(2, 1fr)' rowGap={1} columnGap={0}>
              ...
              <GridItem>
                <Text textAlign='center' fontWeight='bold'>davidchi</Text>
              </GridItem>
              <GridItem>
                <Text textAlign='center' fontWeight='bold'>0</Text>
              </GridItem>
        ...
        <Tr>
          <Td height='15em'>
            <Grid templateColumns='repeat(2, 1fr)' rowGap={1} columnGap={0}>
              ...
              <GridItem >
                <Text textAlign='center' fontWeight='bold'>cherrytree1324</Text>
              </GridItem>
              <GridItem>
                <Text textAlign='center' fontWeight='bold'>0</Text>
              </GridItem>
